...
function reportsPurchaseTableCreator(
	...
	$(tableContainerDivID).load(tableCreatorFileUrl, function () {
		...
		$(tableID).DataTable({
			...
			buttons: [
				"copy",
				{ extend: "csv", footer: true, title: "Laporan Pembelian" },
				{ extend: "excel", footer: true, title: "Laporan Pembelian" },
				{
					extend: "pdf",
					footer: true,
				...
				{ extend: "print", footer: true, title: "Laporan Pembelian" },
			],
...
function reportsSaleTableCreator(
	...
	$(tableContainerDivID).load(tableCreatorFileUrl, function () {
		...
		$(tableID).DataTable({
			...
			buttons: [
				"copy",
				{ extend: "csv", footer: true, title: "Laporan Penjualan" },
				{ extend: "excel", footer: true, title: "Laporan Penjualan" },
				{
					extend: "pdf",
					footer: true,
					orientation: "landscape",
				...
				{ extend: "print", footer: true, title: "Laporan Penjualan" },
			],
			footerCallback: function (row, data, start, end, display) {
				var api = this.api(),
					data;
...
function calculateTotalInSaleTab() {
	...
	$("#saleDetailsTotal").val(
		Number(unitPriceST) * ((100 - Number(discountST)) / 100) * Number(quantityST)
	);
}
