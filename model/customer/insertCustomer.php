<?php
	...
	if(isset($_POST['customerDetailsCustomerFullName'])){
		...
		if(!empty($fullName) && !empty($mobile) && !empty($address)) {
			...
			if($address == ''){
				// Address 1 is empty
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Harap isi bidang alamat 1.</div>';
				exit();
			}
			...
			if($fullName == ''){
				// Full Name is empty
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Harap isi bidang nama lengkap.</div>';
				exit();
			}
			...
			echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>Pelanggan berhasil ditambahkan</div>';
		} else {
