	...
	if(isset($_POST['vendorDetailsStatus'])){
		...
		if(!empty($fullName) && !empty($mobile) && !empty($address)) {
			...
			if($mobile == ''){
				...
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Harap isi bidang nama.</div>';
				exit();
			}
			...
			if($mobile == ''){
				// Mobile phone 1 is empty
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Harap isi bidang nomor telepon.</div>';
				exit();
			}
			...
			echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>Supplier berhasil ditambahkan</div>';
		} else {
